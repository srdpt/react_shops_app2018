...
getGroup("https://ckdata.firebaseio.com/groups/MERGE%20Stores%202012.json",{tag: "Tourist Stores", filter:function(obj){
    if(obj["2015"]){ 
...
getGroup("https://ckdata.firebaseio.com/groups/MERGE%20Stores%202012.json",{tag: "Resident Stores", filter:function(obj){
    if(obj["2015"]){ 
...
getGroup("https://ckdata.firebaseio.com/groups/MERGE%20Stores%202012.json",{tag: "Mixed Stores", filter:function(obj){
    if(obj["2015"]){ 
            if(obj["2015"]["shop_type"] == "Mixed"){
                return true;    
            }  
    }
